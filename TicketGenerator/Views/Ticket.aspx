        ...
        <script type="text/javascript">
            function printTicket() {
               ...
               generateButton_Click();
                ...
                printWindow.document.write('<html><head><title>Ticket</title><style type="text/css" media="print">@page { size: landscape; }</style></head><body>');
            ...
            function generateButton_Click() {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $("#qrCodeContainer").html("<img style=\"z-index:99;height: 200px;position: fixed;width: 188px;height: 188px;top: 136px;left: 859px;background-color: #d9d9d9;\" src=\"data:image/png;base64," + response + "\" alt=\"QR Code\" />");
                    },
...
<div id="ticket" style="max-width:600px;">
 <div  class="image"><img class="flight-number-date" src="App_Data/flight-number-date-1.jpg" /></div>
